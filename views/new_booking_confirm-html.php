                                                        ...
                                                        <td style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; font-size:15px; color:#23496d; word-break:break-word; padding:10px 20px">
                                                            <div id="hs_cos_wrapper_module_15615388260943" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                                                                <div id="hs_cos_wrapper_module_15615388260943_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text">
                                                                    ...
                                                                    <p style="mso-line-height-rule: exactly;line-height: 175%;margin: 0;"><span style="color: #000000;"><strong><?php echo l('channex_integration/Total room charges', true); ?>:&nbsp;</strong><?php echo number_format($rate, 2, ".", ","); ?></span></p>
                                                                    <p style="mso-line-height-rule: exactly;line-height: 175%;margin: 0;"><span style="color: #000000;"><strong><?php echo l('channex_integration/Tax', true); ?>:&nbsp;</strong><?php $tax = floatval($rate_with_taxes) - floatval($rate); echo number_format($tax, 2, ".", ","); ?></span></p>
                                                                    <p style="mso-line-height-rule: exactly;line-height: 175%;margin: 0;"><span style="color: #000000;"><strong><?php echo l('channex_integration/Grand Total', true); ?>:&nbsp;</strong><?php echo number_format($rate_with_taxes, 2, ".", ","); ?></span></p>
                                                                    <p style="mso-line-height-rule: exactly;line-height: 175%;margin: 0;"><span style="color: #000000;"><strong><?php echo l('channex_integration/Average daily rate', true); ?>:&nbsp;</strong><?php echo number_format($average_daily_rate, 2, ".", ","); ?></span></p>
                                                                    <p style="mso-line-height-rule: exactly;line-height: 175%;margin: 0;"><span style="color: #000000;"><strong><?php echo l('channex_integration/Amount due', true); ?>:&nbsp;</strong><?php echo number_format($amount_due, 2, ".", ","); ?></span></p>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
