...
<html>
<head>
    <title><?php echo $company_name; ?> <?php echo l('channex_integration/Booking Cancellation', true); ?>: <?php echo $booking_id;?></title>
    <style type="text/css">
...
<div style="max-width: 600px;">
    ...
    </h4><?php echo l('channex_integration/Your booking has been cancelled', true); ?></h4>
    <h4> <?php echo $content; ?> </h4>


    <div >
        <span class="label"><?php echo l('channex_integration/Booking ID', true); ?>:</span>
        <?php echo $booking_id; ?>
        <br />
        <span class="label"><?php echo l('channex_integration/Check-in Date', true); ?>:</span>
        <?php echo $check_in_date; ?>
        <br />
        <span class="label"><?php echo l('channex_integration/Check-out Date', true); ?>:</span>
